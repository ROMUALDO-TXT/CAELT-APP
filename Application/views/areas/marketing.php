    ...
    <div class="container">
        <div class="container painelbase">
            <div class="jumbotron">
                <div class="gestao">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <img class="membroGestao" src="../public/assets/img/diretoria/2022-2023/diretoria-marketing.jpg" alt="Diretor do financeiro">
                            <h3>Diretor de marketing</h3>
                            <h4>André Luiz Alves</h4>
                            <h5>Ingressante de 2021</h5>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <img class="membroGestao" src="../public/assets/img/diretoria/2022-2023/adjunto-marketing.jpg" alt="Diretor adjunto do financeiro">
                            <h3>Diretor adjunto de marketing</h3>
                            <h4>Marcos Cláudio Donato Silva </h4>
                            <h5>Ingressante de 2021</h5>
                        </div>
                    </div>
                ...
                <hr>
                <p>A Diretoria de Marketing tem como objetivo a criação de artes e conteúdos para as redes sociais,
                bem como posts, interações, avisos e comemorações sobre o curso. 
                A Diretoria de Marketing é responsável também pela identidade visual do Centro Acadêmico, 
                garantindo o uso adequado da paleta de cores, símbolos e logos relacionadas ao curso e a UNIFEI.
            </p>
            </div>
        </div>
